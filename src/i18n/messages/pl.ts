  ...
  cupsPage: {
    ...
    quote: {
      ...
      products: [
        ...
        "Kubek jednowarstwowy z nadrukiem (biały lub kraft)",
        "Kubek dwuwarstwowy termiczny z nadrukiem (biały, kraft lub kombi)",
        "Kubki papierowe z magazynu, bez nadruku (białe, kraft lub wzory)",
        "Transparentny kubek rPET (zimne napoje)",
        "Miska na lody / deser (tylko zimne)",
        "Wieczka (PE plastik lub BIO papier)",
        "Słomki papierowe",
