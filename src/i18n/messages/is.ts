const is = {
  ...
  cupsPage: {
    ...
    eco: {
      ...
      steps: [
        { n: "01", t: "Hönnun", d: "Plöntu-byggð PLA húðun í stað jarðefnaplasts. Prentblek valið til að halda bollanum niðurbrjótanlegum." },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Get ég séð sýnishorn fyrst?", a: "Já. Slétt lagersýni eru ókeypis. Sérprentuð sýni bera lítið framleiðslugjald, sem dregst frá fyrstu raunverulegu pöntun." },
        { q: "Verður hver lota eins?", a: "Innan ±15% litabreytileika milli framleiðslulota (iðnaðarstaðall). Rauður helst rauður, en nákvæm tónn getur breyst lítillega. Pappírsþyngd, lokafesting og mál eru læst í forskrift." },
        ...
        { q: "Þarf ég langtímasamning?", a: "Nei. Hver pöntun er sjálfstæð. Pantaðu einu sinni eða settu upp endurtekna afhendingu, þitt val." },
    ...
    productCatalog: [
      {
        ...
        desc: "Vinnubollinn. Léttur, staflanlegur, full-vafðs prentun án litatakmörkunar. Fyrir viðburði, skrifstofur, safabar og vatnsvélar.",
        bullets: ["Ótakmörkuð fjöllita prentun, engin viðbót", "Endurvinnanleg eða niðurbrjótanleg innri húðun", "Aðeins lógó eða full-vafðs prentun"],
        moq: "1.000 stk",
      },
      {
      ...
      },
      {
        ...
        desc: "Ódýrari tvíveggja, þykkari en einveggja, ódýrari en premium. Góður millivegur fyrir heitt kaffi, te og glögg.",
      ...
      },
      {
        ...
        sizes: "100 · 180 · 250 · 300 · 400 ml",
        desc: "Óprentaðir bollar beint úr lager. Tilvalið fyrir vatnsstöðvar, sjálfsala, líkamsræktarstöðvar og skrifstofur. Seldir í kassa, ekkert prentlágmark.",
      ...
      },
      {
        ...
        desc: "Krystalstær bolli fyrir kalda drykki, smoothies, ískaffi, bjór, kokteila. Endurunnið PET. Lögleg endurnýjun á gömlum einnota plastbollum.",
      ...
      },
      {
        ...
        desc: "Víðopuð skál fyrir ís, jógúrt, súpu og snarl. Alltaf BIO-húðuð. Sérprentuð eða óprentuð.",
        bullets: ["100% niðurbrjótanleg BIO húðun", "Sérsniðin full-vafðs prentun í boði", "Algilt forhönnuð mynstur einnig á lager"],
        moq: "1.000 stk",
      },
      {
