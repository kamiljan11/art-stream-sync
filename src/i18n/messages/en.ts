  ...
  cupsPage: {
    ...
    quote: {
      ...
      products: [
        ...
        "Single-wall paper cup, printed (white or kraft)",
        "Double-wall thermal cup, printed (white, kraft or combo)",
        "Plain paper cups, stock (white, kraft or patterned — no print)",
        "Transparent rPET cup (cold drinks)",
        "Ice cream / dessert bowl (cold use only)",
        "Lids (PE plastic or BIO paper)",
