const is = {
  ...
  cupsPage: {
    ...
    eco: {
      ...
      p3b: "ýmsar nútíma eco-húðanir",
      p3c: ", plöntu-byggða niðurbrjótanlega PLA, vatnsbasaðar dispersion-húðanir og aðrar plastlausar lausnir. Sama tilfinning, sami hitaþol, sama bragð, en",
      p3d: "núll örplast",
    ...
    productCatalog: [
      {
        ...
        desc: "Vinsælasti bollinn okkar. Léttur, staflanlegur, prentun á alla yfirborðið án litatakmörkunar. Hentar fyrir viðburði, skrifstofur, safabar og vatnsvélar.",
