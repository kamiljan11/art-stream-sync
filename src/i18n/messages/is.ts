    ...
    productCatalog: [
      {
        ...
        desc: "Vinsælasti bollinn okkar. Léttur, staflanlegur, prentun á alla yfirborðið án litatakmörkunar. Prentað á hvítan eða náttúrulegan kraftpappír (brúnan). Hentar fyrir viðburði, skrifstofur, safabar og vatnsvélar.",
        bullets: ["Ótakmörkuð fjöllita prentun, engin viðbót", "Hvítur eða kraftpappír (brúnn)", "Endurvinnanleg eða niðurbrjótanleg innri húðun"],
        moq: "1.000 stk",
      },
      {
        ...
        desc: "Premium tvíveggja bolli. Heldur drykknum heitum en er þægilegur að halda á. Fáanlegur með hvítum eða kraft (brúnum) ytri vegg. Mælt með fyrir kaffihús, take-away og kaffihorn hótela.",
        bullets: ["Þægilegur að halda á jafnvel með heitum drykkjum", "Hvítur eða kraft (brúnn) ytri veggur", "Endurvinnanleg eða niðurbrjótanleg innri húðun"],
        moq: "1.000 stk",
      },
      {
        tag: "Lager · óprentað",
