  ...
  cupsPage: {
    ...
    quote: {
      ...
      products: [
        ...
        "Einveggja pappírsbolli, prentaður (hvítur eða kraft)",
        "Tvíveggja hita bolli, prentaður (hvítur, kraft eða combo)",
        "Sléttir pappírsbollar af lager, óprentaðir (hvítir, kraft eða mynstraðir)",
        "Glær rPET bolli (kaldir drykkir)",
        "Ís / eftirréttarskál (eingöngu fyrir kalt)",
        "Lok (PE plast eða BIO pappír)",
        "Pappírssogrör",
        "Tréhrærur / íspinnar",
      ...
      byProduct: [
        ...
        { sizes: ["300 ml", "400 ml", "500 ml", "Blanda af stærðum"], finishes: [], linings: [] },
        ...
        { sizes: [], finishes: ["Hvítur", "Svartur", "Grænn", "Rauður", "Appelsínugulur", "Gull", "Silfur", "Annað"], linings: [] },
