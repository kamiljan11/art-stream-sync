  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          We've received your message and our Icelandic brokerage team will get
          back to you shortly with a quote or next steps.
        </Text>
        <Section style={card}>
          <Text style={cardTitle}>What happens next</Text>
          <Text style={cardText}>
            • We review your request<br />
            • You'll get a fixed ISK quote within 24 hours<br />
...
const accent = { borderColor: '#00AEEF', borderWidth: '2px', borderStyle: 'solid', margin: '0 0 24px', width: '40px' }
...
const cardTitle = { fontSize: '12px', fontWeight: 800 as const, letterSpacing: '0.1em', color: '#EC008C', margin: '0 0 10px', textTransform: 'uppercase' as const }
