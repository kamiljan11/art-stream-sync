    ...
    productCatalog: [
      {
        ...
        desc: "Our most popular cup. Light, stackable, full-surface print with no colour limit. Print on white or natural kraft (brown) paper. Suitable for events, offices, juice bars and water dispensers.",
        bullets: ["Unlimited full-colour printing, no upcharge", "White or kraft (brown) paper base", "Recyclable or compostable inner lining"],
        moq: "1,000 pcs",
      },
      {
        ...
        desc: "Premium double-wall cup. Keeps drinks hot inside while staying comfortable to hold. Available with white or kraft (brown) outer wall. Recommended for cafés, takeaway and hotel coffee corners.",
        bullets: ["Comfortable to hold even with hot drinks", "White or kraft (brown) outer wall", "Recyclable or compostable inner lining"],
        moq: "1,000 pcs",
      },
      {
        tag: "Stock · no print",
