const pl = {
  ...
  cupsPage: {
    ...
    eco: {
      ...
      p3b: "roślinną, kompostowalną barierę PLA",
      p3c: ". Ten sam dotyk, ta sama odporność na ciepło, ten sam smak, ale",
      p3d: "zero mikroplastiku",
      p3e: ", i rozkłada się w kompostowniach przemysłowych. Działa dla gorącej kawy, zimnych napojów i lodów.",
      stat1: "Papier FSC",
    ...
    productCatalog: [
      {
        ...
        desc: "Kubek-koń roboczy. Lekki, sztaplowalny, druk full-wrap bez limitu kolorów. Na eventy, biura, soczarnie i dystrybutory wody.",
      ...
      },
      {
        ...
        desc: "Budżetowy dwuwarstwowy, grubszy niż jednowarstwowy, tańszy niż premium. Solidny złoty środek dla gorącej kawy, herbaty i grzańca.",
      ...
      },
      {
        ...
        sizes: "100 · 180 · 250 · 300 · 400 ml",
        desc: "Bez nadruku, bez kombinowania, prosto z magazynu. Idealny do stacji wodnych, automatów, siłowni i biur. Sprzedawany kartonami, bez minimum druku.",
      ...
      },
      {
        ...
        desc: "Kryształowo czysty kubek do zimnych napojów, smoothie, mrożonej kawy, piwa, koktajli. Recyklingowane PET. Legalny zamiennik starych jednorazówek plastikowych.",
