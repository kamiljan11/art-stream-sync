...
const COPY: Record<string, { preview: string; intro: string; next: string[] }> = {
  ...
  audit: {
    ...
    intro:
      "We've received your price match audit request. We'll review your current pricing and get back to you.",
  ...
  brief: {
    ...
    next: [
      "✓ ISK quote based on your brief within 24 hours",
...
export const QuoteConfirmationEmail = ({ name, type }: Props) => {
