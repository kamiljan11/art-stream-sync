  ...
  cupsPage: {
    ...
    quote: {
      ...
      byProduct: [
        ...
        { sizes: ["100 ml", "180 ml", "200 ml", "300 ml", "400 ml", "Mix of sizes"], finishes: ["White", "Kraft (brown)", "Pastel pattern", "Coffee-bean pattern", "Summer graphics", "Winter graphics"], linings: ["Not sure yet, advise me", "Standard (Green PE)", "Compostable BIO (water-based dispersion, plastic-free)"] },
