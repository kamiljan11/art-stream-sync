const en = {
  ...
  cupsHero: {
    ...
    cta: "Get a quote",
    badge: "ISK quote in 24 hours. No contract.",
  },
  footer: {
  ...
  cupsPage: {
    ...
    midCta: {
      a: {
        ...
        sub: "Send us your brief — ISK quote back in 24h (workdays).",
    ...
    quote: {
      ...
      wizard: {
        ...
        qty: "Qty",
        customQuantityLabel: "Or enter exact quantity",
        customQuantityPlaceholder: "e.g. 7500",
