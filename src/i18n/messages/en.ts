const en = {
  ...
  cupsPage: {
    ...
    eco: {
      ...
      h3p1: "Drop the plastic. Keep the",
      h3p2: "cup.",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Will every batch look identical?", a: "Within ±15% colour variance between runs (industry standard). Red stays red, but the exact shade can shift slightly. Paper weight, lid fit and dimensions are locked in spec." },
        ...
        { q: "Do I need a long-term contract?", a: "No. Every order is independent. Order once or set up a recurring delivery, your call." },
