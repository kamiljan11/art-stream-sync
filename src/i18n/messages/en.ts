  ...
  cupsPage: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Can I order eco / biodegradable cups?", a: "Yes, every paper line can be ordered with a BIO (compostable PLA) lining instead of standard Green PE. Same feel, same heat resistance, no microplastics, EN 13432 compostable. Just tick it in the quote form." },
