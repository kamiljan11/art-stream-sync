    ...
    productCatalog: [
      {
        ...
        desc: "Nasz najpopularniejszy kubek. Lekki, sztaplowalny, nadruk na całej powierzchni bez limitu kolorów. Druk na białym papierze lub naturalnym papierze kraft (brązowym). Sprawdzi się na eventy, do biur, soczarni i dystrybutorów wody.",
        bullets: ["Nieograniczony druk pełnokolorowy, bez dopłat", "Papier biały lub kraft (brązowy)", "Bariera wewnętrzna do recyklingu lub kompostowalna"],
        moq: "1 000 szt.",
      },
      {
        ...
        desc: "Premium kubek dwuwarstwowy. Utrzymuje gorący napój w środku, a jednocześnie pozostaje wygodny w trzymaniu. Dostępny z białą lub kraftową (brązową) zewnętrzną ścianką. Polecany dla kawiarni, na wynos i do hotelowych kącików kawowych.",
        bullets: ["Wygodny w trzymaniu nawet z gorącym napojem", "Zewnętrzna ścianka biała lub kraft (brązowa)", "Bariera wewnętrzna do recyklingu lub kompostowalna"],
        moq: "1 000 szt.",
      },
      {
